...
# Database: uc_proj
# Generation Time: 2016-11-11 00:20:56 +0000
# ************************************************************
...
INSERT INTO `car` (`id`, `company`, `name`, `price`, `thumbnail`, `dealer_id`, `status`, `hit_count`)
VALUES
	(1,'기아','K5 2.0 스마트',10000000,'thumbnail_path',1,0,0),
	(2,'기아','K3 1.6 GDI 트랜디',1000000,'thumbnail_path',1,0,0);
